    ...
    return (
        <div>
            ...
            <DrawerContent>
                ...
                <Button variant={buttonVariant} mr={3} className='menubutton' onClick={() => OnMenuButtonClick("whatIsNetball", navDrawerProps.setPage, onClose)}>What is Netball?</Button>
                <Button variant={buttonVariant} mr={3} className='menubutton' onClick={() => OnMenuButtonClick("membershipInfo", navDrawerProps.setPage, onClose)}>Membership Info</Button>
